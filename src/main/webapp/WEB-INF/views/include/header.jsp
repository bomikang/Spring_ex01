  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="${pageContext.request.contextPath}/${pageContext.request.contextPath}/resources/index2.html" class="logo">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="${pageContext.request.contextPath}/sboard/list"><i class="fa fa-circle-o"></i>게시판 v1</a></li>
